...
// HTTP behaviour is covered in steam_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "steam://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("steam", "about")
	if err != nil || got.String() != "steam://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want steam://page/about", got.String(), err)
	}
}
