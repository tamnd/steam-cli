...
steam links <path>           # the pages it links to, each addressable
steam serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading steam by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address steam as
  `steam://` URIs and follow links across sites. See
