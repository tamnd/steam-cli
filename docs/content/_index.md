---
title: "steam"
description: "Browse the Steam game store"
heroTitle: "steam, from the command line"
heroLead: "Browse the Steam game store One pure-Go binary, no API key, output that pipes into the rest of your tools."
...
```bash
steam --help            # the command tree
steam version           # build info
```
