...
Most of these come down to network reality or how steam serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

steam rate-limits like any public site. steam already paces
...
Where a surface is gated, steam reads a cookie or token you supply
...
`steam`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what steam actually did
